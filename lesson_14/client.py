...
def main():
    ...
    try:
        ...
        print(f'---PASWD_HASH--- {passwd_hash_str}')

        message = processing_presence(user_name)
        print('*****************', message)
        send_message(s, message)
        # message_data = '715e4ce072f4072f03558caeb81e498e191140e5b1f3b0f37a2628febc2497f37b078087de3698f2d4d4b19325232f57408f742c9f47791cf2605ad78e7303c3'

        # hash = hmac.new(passwd_hash_str, message_data.encode('utf-8'), 'MD5')
        # print('ccccccc', passwd_hash_str, message_data.encode('utf-8'), hash)
        # digest = hash.digest()
